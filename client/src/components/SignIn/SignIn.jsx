        ...
        return (
            <main className="pa4 black-80">
                <div className="measure center">
                    ...
                    <div className="">
                        <input onClick={this.onSubmitSignIn} className="b ph3 pv2 input-reset ba b--black bg-transparent hover-bg-black hover-white grow pointer f6 dib" type="submit" value="Sign in" />
                    </div>
                    <div className="lh-copy mt3">
                        <p onClick={() => onRouteChange("register")} className="f6 link dim black pointer dib">Register</p>
                    </div>
                </div>
            </main>
        )
